...
const SPRITES: Record<PixelVariant, Sprite> = {
  mother: {
    hair: "#6B4A2F", skin: "#F8CFA0", top: "#C96F6F", bottom: "#5A3A3A",
    back: [
      [2.5, 3, 1, 5, "#6B4A2F"],   // 左侧垂发（细条）
      [8.5, 3, 1, 5, "#6B4A2F"],   // 右侧垂发
    ],
    front: [
      [3.4, 1.6, 5.2, 1.8, "#6B4A2F"],                  // 刘海
      [3, 3.2, 0.8, 1.4, "#6B4A2F"], [8.2, 3.2, 0.8, 1.4, "#6B4A2F"], // 鬓角
